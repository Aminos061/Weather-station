...
class WeatherStation {
  ...
  // Factory zur Erstellung von Wetterstationen aus JSON-Daten
  factory WeatherStation.fromJson(String location, Map<String, dynamic> json) {
    ...
    return WeatherStation(
      ...
      address: json['Adresse'].toString(), // Simulated Address from Coordinates
  ...
  static String getAddressFromCoordinates(LatLng coordinates) {
    // Here we're simulating an address. You can replace this logic with real geocoding API calls
    return "Street ${coordinates.latitude.toStringAsFixed(3)}, City ${coordinates.longitude.toStringAsFixed(3)}";
  }
